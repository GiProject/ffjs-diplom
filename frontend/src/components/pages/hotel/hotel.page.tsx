...
import {Hotel, hotelData, HotelSearchParams} from "../../../interfaces/model/hotel.interface";
...
export default function HotelList() {
    ...
    const hotelQuery = async (query: HotelSearchParams) => {
        query = {...query, limit: options.perPage, offset: options.perPage * (page - 1)}

        return await axios.get(`${process.env.BASE_URL}/api/hotels`, {params: query})
    }
            ...
            {hotels.map((hotel: Hotel) => (
                <div className="hotel-item" key={hotel._id}>
                    ...
                    <div className="hotel-content">
                        ...
                        <div className="hotel-link"><Link to={`/hotels/${hotel._id}`}>Подробнее</Link></div>
                    </div>
