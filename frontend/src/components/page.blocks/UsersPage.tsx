...
export default function () {
    ...
    const userQuery = async (query: SearchUserParams = {}) => {
        ...
        return await axios.get(`${process.env.BASE_URL}/api/users`, {params: query})
    }
    ...
    return <div>
        <form onSubmit={onSubmitHandler}>
            <input name="user-search" value={search} placeholder="Поиск пользователей: Имя, телефон или email" onChange={searchInputOnChange}/>
        </form>
